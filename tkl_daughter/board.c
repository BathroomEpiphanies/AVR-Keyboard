...
uint8_t *const  row_ddr[NROW] = { _DDRB,  _DDRB,  _DDRB,  _DDRB,  _DDRB,  _DDRB,  _DDRB,  _DDRB};
uint8_t *const row_port[NROW] = {_PORTB, _PORTB, _PORTB, _PORTB, _PORTB, _PORTB, _PORTB, _PORTB};
uint8_t *const  row_pin[NROW] = { _PINB,  _PINB,  _PINB,  _PINB,  _PINB,  _PINB,  _PINB,  _PINB};
const uint8_t   row_bit[NROW] = {  0x00,   0x02,   0x04,   0x06,   0x08,   0x0A,   0x0C,   0x0E};

/* /\* Specifies the ports and pin numbers for the columns *\/ */
/* uint8_t *const  col_ddr[NCOL] = { _DDRC,  _DDRC}; */
/* uint8_t *const col_port[NCOL] = {_PORTC, _PORTC}; */
/* uint8_t *const  col_pin[NCOL] = { _PINC,  _PINC}; */
/* const uint8_t   col_bit[NCOL] = { _BIT6,  _BIT7}; */

/* Specifies the ports and pin numbers for the columns */
uint8_t *const  col_ddr[NCOL] = {                                 _DDRB,                  _DDRB,
				                                                  _DDRC,  _DDRC,
				  _DDRD,  _DDRD,  _DDRD,  _DDRD,  _DDRD,  _DDRD,  _DDRD,  _DDRD,
				  _DDRF,  _DDRF,                  _DDRF,  _DDRF,  _DDRF,  _DDRF};

uint8_t *const col_port[NCOL] = {                                _PORTB,                 _PORTB,
				 _PORTC, _PORTC,
				 _PORTD, _PORTD, _PORTD, _PORTD, _PORTD, _PORTD, _PORTD, _PORTD,
				 _PORTF, _PORTF,                 _PORTF, _PORTF, _PORTF, _PORTF};

uint8_t *const  col_pin[NCOL] = {                                 _PINB,                  _PINB,
				  _PINC,  _PINC,
				  _PIND,  _PIND,  _PIND,  _PIND,  _PIND,  _PIND,  _PIND,  _PIND,
				  _PINF,  _PINF,                  _PINF,  _PINF,  _PINF,  _PINF};

const uint8_t   col_bit[NCOL] = {                                 _BIT4,                  _BIT7,
				                                                  _BIT6,  _BIT7,
